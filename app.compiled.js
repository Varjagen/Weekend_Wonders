...
// Campaign-specific: The Plague's Call — Jake and Tully
{
  id: 'builtin:jake',
  name: 'Jake',
  builtin: true,
...
// Campaign NPCs: Coalan, Yevgeny, Ernest, Laughing Puppet, Angmar, Barry
{
  id: 'builtin:coalan',
  name: 'Coalan the Physician',
  builtin: true,
  entity: {
    type: 'NPC', name: 'Coalan', color: '#8ab4c2',
...
DISPOSITION: Helpful. Genuinely tries to assist the party. Not hostile.

TRAIT: LACUNAE
His memory has literal gaps. Midway through sharing information he may stop, blink slowly, and say "I had something important to tell you about that" before going quiet. Roll d6 at key moments:
  1–2: Memory hole — loses the thread entirely, visibly distressed.
  3–4: Partial recall — incomplete but useful information.
  5–6: Clear window — speaks with alarming coherence before it closes.

ACTIONS
Healing Touch: Cures 1d8+3 HP (action). Reflexive — does not require consent.
...
He calls the Puppetmaster "the doctor who helped me" and will not hear otherwise.`
  ...
  builtin: true,
  entity: {
    type: 'NPC', name: 'Yevgeny', color: '#5c3d6e',
...
Pact Slots: 4th level ×2 (recover on short rest)
Invocations: Agonizing Blast, Devil's Sight, Repelling Blast

DISPOSITION: Hostile to outsiders. Will not attack unprovoked.
Provocation: threatening him, entering his sanctum, naming the Puppetmaster approvingly.

TRAIT: PUPPETED FAITH
Still speaks of his god. Responds to sincere theological discussion with something like genuine interest — a soft point.

ACTIONS
Eldritch Blast: +7 to hit, 2 beams, 1d10+4 force + push 10 ft.
Toll the Dead: DC 15 WIS save, 2d12 necrotic if target is damaged.
Hunger of Hadar (4th slot): 20 ft sphere, blindness, 2d6 cold + 2d6 acid/round.
Counterspell (3rd slot): Reaction, auto-counters ≤3rd level spells.

He knew the Puppetmaster before the infection. He has not tried to leave. Ask him why.`
  }
}, {
  ...
  entity: {
    ...
    notes: `Ernest the Broken Puppet | CR 5 | Medium Monstrosity | AC 14 | HP 104 | Speed 30 ft
STR 18 (+4) | DEX 8 (−1) | CON 16 (+3) | INT 4 (−3) | WIS 8 (−1) | CHA 3 (−4)
Darkvision 60 ft | Resistances: Bludgeoning, Piercing | Immunities: Charmed, Frightened, Poisoned

LORE: Once a policeman. The Puppetmaster's first failed experiment. Stalks the forest at night.

TRAIT: WRONG DIRECTIONS
Limbs attached in incorrect orientations. Reactions against his attacks are made at disadvantage.

TRAIT: CALMED, NOT CURED
DC 14 CHA (Persuasion) using his real name, or a recognised object, stops the attack.
He sits down and begins to cry — a faint wooden creak, rhythmic, continuous. He cannot be restored.

ACTIONS (Multiattack: 2 strikes)
Broken Fist: +7 to hit, 1d10+4 bludgeoning. DC 14 STR save or knocked prone.
Wrenching Grab: +7 to hit, 1d6+4 bludgeoning + grappled (escape DC 15). Grappled = Restrained.

REACTION: WRONG WAY
When hit by melee: attacker makes DC 13 DEX save or their attack hits an adjacent creature.
...
Darkvision 120 ft | Skills: Stealth +8, Acrobatics +7, Deception +6, Perception +4
Immunities: Frightened

TRAIT: UNNATURAL SQUEEZE
Moves through any space large enough for a Small creature without penalty. Ignores cramped difficult terrain.

TRAIT: GIBBERING PRESENCE
Creatures starting their turn within 20 ft: DC 14 WIS save or Frightened until start of next turn.
Fail by 5+: also uses reaction to move directly away from her.

TRAIT: SHADOW OF THE PIPE
Advantage on Stealth in dim light/darkness. Cannot be tracked by non-magical means.

ACTIONS
Multiattack: Two Rake attacks, or one Rake and one Mind Splinter.
Rake: +7 to hit, 1d8+4 slashing + 1d6 psychic.
Mind Splinter (Recharge 5–6): DC 14 WIS save. Fail: 3d8 psychic + Stunned until end of next turn. Success: half.
Lure (Bonus Action): One creature within 60 ft, DC 13 WIS save or move toward her.

REACTION: SLIP
When targeted by attack: move up to 10 ft without provoking opportunity attacks (1/round).

Never fights in the open. Kills the isolated. Finds fear amusing.`
  }
}, {
  id: 'builtin:angmar',
  ...
  builtin: true,
  entity: {
    type: 'NPC', name: 'Angmar', color: '#6b4c1e',
...
Skills: Perception +6 (Expertise), Survival +8, Athletics +6, Stealth +6, Nature +3
Passive Perception 16

APPEARANCE: Potbellied but powerful. Cloak of patchwork bear pelts — hundreds of pieces.
Loud by default. Laughs at his own stories. Does not whisper in the woods on principle.

PERSONALITY: Warm to those who prove useful. Contemptuous of squeamishness.
Has hunted this forest for twenty years. He knows what walks at night.
He will not say its name. He calls it "the creaking one."

RANGER FEATURES
Favoured Enemy: Constructs, Undead (no terrain penalty, can't be surprised while alert)
Extra Attack: Two attacks per Attack action.
Colossus Slayer: +1d8 once per turn on a target below max HP.
Multiattack Defence: +4 AC after being hit by a creature.

ACTIONS
Longbow: +6 to hit, 1d8+3 piercing, 150/600 ft. + Colossus Slayer 1d8.
Handaxe: +6 to hit, 1d6+3 slashing (two attacks).
Volley (1/short rest): Attack every creature in a 10 ft radius.

SPELLS (2nd-level slots ×3): Hunter's Mark, Ensnaring Strike, Spike Growth, Silence

WHAT HE KNOWS
Knows Ernest's name. Watched him from a distance once. Will not go into the sewers.
Can identify puppet wounds on sight. Has not told anyone what he suspects.`
  }
}, {
  id: 'builtin:barry',
  ...
  builtin: true,
  entity: {
    type: 'NPC', name: 'Barry', color: '#b22222',
...
APPEARANCE: The old town guard uniform — red coat, brass buttons polished to mirrors.
...
PERSONALITY: Formal by training, earnest underneath it. Wants to do right by the town.
Anxious about losing control. Hides it under procedure.

PALADIN FEATURES
Divine Sense: Detects celestials, fiends, undead within 60 ft (4/day).
Lay on Hands: 20 HP pool, cure disease/poison.
Divine Smite: +2d8 radiant on hit (3d8 vs undead/fiends).
...
Shield Bash: +5 to hit, 1d4+3 bludgeoning, DC 13 STR or knocked prone.

SPELLS (1st ×4, 2nd ×2): Bless, Cure Wounds, Shield of Faith, Thunderous Smite, Lesser Restoration, Zone of Truth

WHAT HE KNOWS
His father disappeared investigating reports of strange illness in the outer wards.
He has a box of his father's effects: a badge, a baton, a photograph of a street he doesn't recognise.
He has never shown it to anyone.`
  }
},
// Campaign townspeople: The Plague's Call
{
  id: 'builtin:ivar', name: 'Ivar the Tavernkeeper', builtin: true,
  entity: {
    type: 'NPC', name: 'Ivar', color: '#7a5c3e',
...
Still entirely human. Reserved, not cold. Business is slow.
Tully worked the taproom some evenings. Last saw Tully three weeks ago, looking pale.
Has heard sounds from the cellar at night. Has not gone to check.
Does not serve anyone who comes in after the third bell anymore.

Heavy Mug: +3 to hit, 1d4+1 bludgeoning.`
  }
}, {
  id: 'builtin:charles', name: 'Charles', builtin: true,
  entity: {
    type: 'NPC', name: 'Charles', color: '#4a6e8a',
...
Mid-20s. Married to Elisia. Optimistic by default, working hard to remain so.
...
Found something in the yard two mornings ago. Threw it away before Elisia could see it.
Would very much like someone to tell him everything is fine.

Fists: +2 to hit, 1d4 bludgeoning.`
  }
}, {
  id: 'builtin:elisia', name: 'Elisia', builtin: true,
  entity: {
    type: 'NPC', name: 'Elisia', color: '#8a5e6e',
...
Mid-20s. Married to Charles. Writes letters for hire, handles accounts. Ink-stained fingers.
Sharp. Reads people quickly and accurately. Does not panic — gets very quiet when frightened.
She has been unwell. She knows it is not a winter chill. Has not told Charles.
Has been keeping a list of houses that have gone quiet. Has been writing something. Hasn't finished it.

Penknife: +3 to hit, 1d4+1 piercing.`
  }
}, {
  id: 'builtin:marta', name: 'Marta the Seamstress', builtin: true,
  entity: {
    type: 'NPC', name: 'Marta', color: '#9e6b8a',
    hp: { current: 7, max: 7 }, ac: 10, speed: 30, initBonus: 1,
...
~40. Wiry. Precise. Believes in doing things correctly or not at all.
Made the coats for most of the town guard. Knows which ones aren't coming to collect.
Has been altering more black garments lately. Hasn't asked why.
Saw something cross the yard at night that didn't walk right. Left early. Didn't look back.

Shears: +4 to hit, 1d6+2 piercing.`
  }
}, {
  id: 'builtin:oswin', name: 'Oswin the Baker', builtin: true,
  entity: {
    type: 'NPC', name: 'Oswin', color: '#c49a3a',
...
~35. Round-faced. Genuinely warm. Feeds people as a reflex.
Fewer people buying. Leaves loaves by a house where no one has taken them in four days.
Starts work at four in the morning. Has heard things in the dark he can't account for.
Knows everyone — can say who stopped coming in and roughly when.
Switched to river water two weeks ago. Has no evidence the town water is wrong. Just a feeling.

Rolling Pin: +3 to hit, 1d6+1 bludgeoning.`
  }
}, {
  id: 'builtin:gerrit', name: 'Gerrit the Blacksmith', builtin: true,
  entity: {
    type: 'NPC', name: 'Gerrit', color: '#4a4a4a',
...
~50. Broad. Burn scars on both forearms. Laconic. Respects competence above everything.
Several people have asked him about reinforcing doors. He's done the work without asking why.
Was asked to make something unusual six weeks ago. Declined. Doesn't say by whom.
Keeps a hammer behind the house door. Not the workshop door. Has been sleeping poorly.

Hammer: +5 to hit, 1d6+3 bludgeoning.
Tongs (improvised): +5 to hit, 1d4+3 bludgeoning, DC 13 STR save or target drops held item.`
  }
}, {
  id: 'builtin:pip', name: 'Pip (The Happy Boy)', builtin: true,
  entity: {
    type: 'NPC', name: 'Pip', color: '#e8c84a',
    hp: { current: 4, max: 4 }, ac: 10, speed: 35, initBonus: 2,
    stats: { str: 6, dex: 14, con: 10, int: 10, wis: 10, cha: 15 },
    passivePerception: 10,
    playerDescription: "A boy of perhaps eight with muddy knees and an expression of total confidence in the world. He is looking at you like you are the most interesting thing that has happened to him all week.",
...
~8 years old. Perpetually muddy knees. Gap-toothed grin. Talks to strangers without hesitation.
Asks questions adults would not ask. Has a dog called Marshal.

Plays in parts of town that adults have stopped going to.
Found something near the sewer grate three days ago. Put it in his pocket.
Knows which houses on his street have had their curtains closed for more than a week.
Will tell you any of this if you ask him about his day. He is not afraid.
...
function filterStateForPlayer(state, peerId) {
  ...
  if (claim.spectator) {
    ...
    Object.entries(state.tokens).forEach(([k, t]) => {
      ...
      if (!entity) return;
      if (entity.type === 'PC' || entity.type === 'Familiar' || t.visible) visibleTokens[k] = t;
    });
...
function TokenTooltip({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    style: { background: CONDITION_COLORS[c] || '#555' }
  }, c))));
}
...
function SettingsModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Preferences are stored on this device only.")), mode === 'dm' && /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
    ...
    className: "settings-hint"
  }, "Players see Strong / Rough / Waning / Down instead of numbers. You still see exact values.")), mode === 'player' && /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
...
function EditMySheetModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    min: 0,
    max: 40
  }))), /*#__PURE__*/React.createElement("label", null, "HP"), obfuscateHp ? /*#__PURE__*/React.createElement("div", {
    style: {
      marginBottom: 8,
      padding: '6px 8px',
      background: 'var(--bg-0)',
  ...
  }, "HP hidden by DM \u2014 ", hpLabel(entity.hp.max > 0 ? entity.hp.current / entity.hp.max * 100 : 0).text) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "form-row-2",
    style: {
      marginBottom: 8
    }
...
function PlayerOnboardingGate({
  ...
  }, "Level ", e.level, " ", e.class, " \xB7 ", obfuscateHp ? hpLabel(e.hp.max > 0 ? e.hp.current / e.hp.max * 100 : 0).text : e.hp.max + ' HP', " \xB7 AC ", e.ac)), /*#__PURE__*/React.createElement("button", {
...
function SoundboardPanel({
  ...
  const handleDeleteAll = async () => {
    ...
    try {
      ...
      console.error('[plagues-call] delete all sounds failed:', err);
      toast('Delete failed — see console', 'error');
    }
  };
  return /*#__PURE__*/React.createElement(FloatPanel, {
    style: { right: 16, top: 80, width: 340 }
  }, /*#__PURE__*/React.createElement("div", {
    className: "float-panel-header"
  ...
  /* Play-for target (DM only, only when players connected) */
  ...
  }, "Everyone"), connectedPlayers.map(({ pid, name }) => /*#__PURE__*/React.createElement("button", {
    key: pid,
  ...
  /* Library header with search + delete-all */
  /*#__PURE__*/React.createElement("div", {
    ...
    className: "settings-label-sub"
  }, "\u2014 ", allList.length, " sound", allList.length === 1 ? '' : 's')),
  isDM && allList.length > 0 && /*#__PURE__*/React.createElement("button", {
    className: "btn sm ghost danger",
  ...
  /* Search box */
  allList.length > 3 && /*#__PURE__*/React.createElement("input", {
    type: "text",
  ...
  /* Sound list */
  /*#__PURE__*/React.createElement("div", {
    style: { display: 'flex', flexDirection: 'column', gap: 4, maxHeight: 300, overflowY: 'auto' }
  }, list.length === 0 && /*#__PURE__*/React.createElement("div", {
    style: { fontSize: 11, color: 'var(--ink-dim)', fontStyle: 'italic', padding: 6 }
  ...
  list.map(s => /*#__PURE__*/React.createElement("div", {
    ...
    title: targetPeerId
      ? `Play for ${connectedPlayers.find(p => p.pid === targetPeerId)?.name}`
      : "Play for the table"
  }, "\u25B6"), /*#__PURE__*/React.createElement("button", {
    className: "btn sm ghost",
    onClick: () => onStop(s.id),
...
function PlayerInterface({
  ...
  }, state.obfuscateHp ? hpLabel(claimedEntity.hp.max > 0 ? claimedEntity.hp.current / claimedEntity.hp.max * 100 : 0).text + ' HP' : claimedEntity.hp.current + '/' + claimedEntity.hp.max + ' HP'), /*#__PURE__*/React.createElement("button", {
    className: "btn sm primary",
        ...
        if (conn?.open) {
          try {
            conn.send({
              type: 'state_update',
              payload: {
                ...stripHeavyAssetsForWire(filterStateForPlayer(stateRef.current, pid)),
