...
function TokenTooltip({
  ...
  const showExactHp = isDM || (isOwned && !obfuscateHp) || (!obfuscateHp && PLAYER_HP_VISIBLE_TYPES.has(ent.type));
...
function PartySidebar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    const obfuscate = state.obfuscateHp && !isYou;
