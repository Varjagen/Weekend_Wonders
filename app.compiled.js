  ...
  async joinSession(roomCode, playerId, playerName) {
    ...
    try {
      ...
      this.peer.on('open', id => {
        ...
        conn.on('data', data => {
          if (data.type === 'state_update') this.onStateUpdate?.(data.payload);else if (data.type === 'map_image') this.onMapImage?.(data.mapId, data.dataUrl);else if (data.type === 'token_pos') this.onTokenPos?.(data.tokenId, data.x, data.y, data.mapId);else if (data.type === 'sound_data') this.onSoundData?.(data.soundId, data.name, data.dataUrl);else if (data.type === 'kicked') {
...
function SettingsModal({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "settings-hint"
  }, "Scales the entire map rendering uniformly. Pan/zoom still works on top.")), mode === 'dm' && spectatorVisionMode != null && onSpectatorVisionChange && /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
  }, "Spectator Vision ", /*#__PURE__*/React.createElement("span", {
    className: "settings-label-sub"
  }, "\u2014 what observers see in the dark")), /*#__PURE__*/React.createElement("div", {
    className: "theme-switch"
  }, /*#__PURE__*/React.createElement("button", {
  ...
  }, "\uD83D\uDD6F"), /*#__PURE__*/React.createElement("span", null, "Lights only"), /*#__PURE__*/React.createElement("span", {
    className: "theme-sub"
  }, "Cinematic \u2014 sees what light reveals")), /*#__PURE__*/React.createElement("button", {
  ...
  }, "\uD83D\uDC41"), /*#__PURE__*/React.createElement("span", null, "Party vision"), /*#__PURE__*/React.createElement("span", {
    className: "theme-sub"
  }, "All PCs' darkvision + lights"))), /*#__PURE__*/React.createElement("div", {
    className: "settings-hint"
  }, "Spectators don't have a character, so without this they'd see nothing at night. Pick \"Lights only\" for a cinematic uninvolved-observer feel, or \"Party vision\" if your spectators want full battlefield awareness.")), mode === 'dm' && onExportSession && onImportSession && /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
  }, "Session Data ", /*#__PURE__*/React.createElement("span", {
    className: "settings-label-sub"
  }, "\u2014 full state JSON")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 6
    }
  ...
  }, "\u21E9 Export to JSON"), /*#__PURE__*/React.createElement("button", {
    className: "btn",
    style: {
      flex: 1
    },
  ...
  }, "\u21E7 Import from JSON")), /*#__PURE__*/React.createElement("div", {
    className: "settings-hint"
  }, "Export saves a snapshot of the entire campaign (entities, maps, hazards, drawings, claims, presets). Import replaces the current state \u2014 share with another DM or use as a manual backup.")), /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("div", {
    className: "settings-hint",
    style: {
...
function ResizableSidebar({
  ...
  const collapseArrow = collapsed ? side === 'left' ? '▸' : '◂' : side === 'left' ? '◂' : '▸';
  ...
  }, collapseArrow), !collapsed && /*#__PURE__*/React.createElement("div", {
    className: "sidebar-inner"
  }, children), !collapsed && /*#__PURE__*/React.createElement("div", {
...
function MeasureMenu({
  ...
  const label = measureMode === 'line' ? '↔ Line' : measureMode === 'radius' ? '⊚ Radius' : '↔ Measure';
  return /*#__PURE__*/React.createElement("div", {
    className: "tools-menu-wrap",
    ref: wrapRef
  }, /*#__PURE__*/React.createElement("button", {
    className: `btn ${measureMode ? 'active' : ''} ${open ? 'active' : ''}`,
    onClick: () => setOpen(o => !o),
  ...
  }, "point-to-point distance")), /*#__PURE__*/React.createElement("button", {
    className: `tools-item ${measureMode === 'radius' ? 'active' : ''}`,
    onClick: choose('radius')
  }, "\u229A Radius ", /*#__PURE__*/React.createElement("span", {
    className: "tools-hint"
  }, "circle from a center")), measureMode && /*#__PURE__*/React.createElement("button", {
...
function ShapesMenu({
  ...
  const label = placingBlock ? '◼ Rect…' : placingFreeBlock ? '✎ Free…' : placingCircleBlock ? '⬤ Circle…' : erasingBlock ? '✕ Erasing…' : '◧ Shapes';
  return /*#__PURE__*/React.createElement("div", {
    className: "tools-menu-wrap",
    ref: wrapRef
  }, /*#__PURE__*/React.createElement("button", {
    className: `btn ${anyActive ? 'active' : ''} ${open ? 'active' : ''}`,
    onClick: () => setOpen(o => !o),
  ...
  }, "Block Zones"), /*#__PURE__*/React.createElement("button", {
    className: `tools-item ${placingBlock ? 'active' : ''}`,
    onClick: choose('rect')
  }, "\u25FC Rectangle ", /*#__PURE__*/React.createElement("span", {
    className: "tools-hint"
  }, "click-drag")), /*#__PURE__*/React.createElement("button", {
    className: `tools-item ${placingFreeBlock ? 'active' : ''}`,
    onClick: choose('free')
  }, "\u270E Freeform ", /*#__PURE__*/React.createElement("span", {
    className: "tools-hint"
  }, "draw a polygon")), /*#__PURE__*/React.createElement("button", {
    ...
    className: "tools-hint"
  }, "draw to subtract"))), /*#__PURE__*/React.createElement("div", {
    className: "tools-section"
  }, /*#__PURE__*/React.createElement("div", {
    className: "tools-section-title"
  }, "Hazards"), /*#__PURE__*/React.createElement("button", {
    ...
    className: "tools-hint"
  }, "fire / flood / cold / acid / fog / difficult")))));
}
...
function RestMenu({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    onClick: choose(onLongRest)
  }, "\u26ED Long Rest", /*#__PURE__*/React.createElement("span", {
    className: "tools-hint"
  }, "full HP, clear most conditions")), /*#__PURE__*/React.createElement("button", {
    className: "tools-item",
    onClick: choose(onShortRest)
  }, "\u26E3 Short Rest", /*#__PURE__*/React.createElement("span", {
    className: "tools-hint"
  }, "\xBC HP, clear short-term conditions")))));
}
function ToolsMenu({
  isDM,
  // measure
...
function PushViewPanel({
  ...
  return /*#__PURE__*/React.createElement(FloatPanel, {
    ...
    className: "float-panel-header"
  }, /*#__PURE__*/React.createElement("span", null, "\u2691 Push View"), /*#__PURE__*/React.createElement("button", {
    className: "close-x",
    onClick: onClose
  }, "\xD7")), /*#__PURE__*/React.createElement("div", {
    className: "float-panel-body"
  ...
  }, "Force what map players see. Useful for cinematic reveals, combat transitions, or making sure everyone is looking at the right scene."), /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
    ...
    onClick: pushGlobal
  }, state.forcedView?.mapId === currentMapId ? '⚑ Release All' : '⚑ Push current map to All'), /*#__PURE__*/React.createElement("button", {
    className: "btn sm ghost",
    onClick: clearAllPush
  }, "Clear all pushes")), /*#__PURE__*/React.createElement("div", {
    className: "settings-hint"
  }, "Global push overrides per-peer. Releasing it returns each player to their own current map.")), /*#__PURE__*/React.createElement("div", {
    className: "settings-section"
  }, /*#__PURE__*/React.createElement("label", {
    className: "settings-label"
  }, "Per-Player"), peers.length === 0 ? /*#__PURE__*/React.createElement("div", {
    className: "settings-hint"
...
function DMInterface({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "\uD83D\uDD76 Hide All"), /*#__PURE__*/React.createElement(MeasureMenu, {
    measureMode: measureMode,
    setMeasureMode: setMeasureMode
  }), /*#__PURE__*/React.createElement("button", {
    className: `btn ${showDraw ? 'active' : ''}`,
    onClick: () => setShowDraw(!showDraw),
    title: "Drawing tools"
  }, "\u270E Draw"), /*#__PURE__*/React.createElement(ShapesMenu, {
    ...
    className: `btn ${showGroups ? 'active' : ''}`,
    onClick: () => setShowGroups(!showGroups),
    title: "Encounter \u2014 token groups"
  }, "\u22F1 Encounter"), /*#__PURE__*/React.createElement("button", {
    className: `btn ${showDice ? 'active' : ''}`,
    onClick: () => setShowDice(!showDice),
    title: "Dice tray"
  }, "\uD83C\uDFB2 Dice"), /*#__PURE__*/React.createElement("button", {
    className: `btn ${showSounds ? 'active' : ''}`,
    onClick: () => setShowSounds(!showSounds),
    title: "Soundboard"
  }, "\uD83D\uDD0A Sounds"), /*#__PURE__*/React.createElement("button", {
    className: `btn ${placingReminder ? 'active' : ''}`,
    ...
    className: `conn-dot ${syncStatus === 'live' ? 'live' : syncStatus === 'connecting' || syncStatus === 'reconnecting' ? 'connecting' : syncStatus === 'error' ? 'error' : ''}`
  }), /*#__PURE__*/React.createElement("span", {
    className: "mono"
    ...
    className: "main"
  }, /*#__PURE__*/React.createElement(ResizableSidebar, {
    id: "dm-bestiary",
    side: "left",
    defaultWidth: 280,
    minWidth: 200,
  ...
  }), showPushView && /*#__PURE__*/React.createElement(PushViewPanel, {
    state: state,
    dispatch: dispatch,
    toast: toast,
    ...
    onSpectatorVisionChange: mode => dispatch({
      type: 'SPECTATOR_VISION_SET',
      mode
    })
  }));
}
...
function PlayerInterface({
  ...
  const visionSourceIds = useMemo(() => {
    ...
    for (const [eid, ent] of Object.entries(state.entities || {})) {
      ...
      if (spectatorVisionMode === 'all') {
        if (ent.type === 'PC' || ent.type === 'Familiar') s.add(eid);else if ((ent.lightRadius || 0) > 0) s.add(eid);
      } else {
  ...
  const visionOwned = useMemo(() => Array.from(visionSourceIds).map(id => state.entities[id]).filter(Boolean), [visionSourceIds, state.entities]);
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: `btn ${showInit ? 'active' : ''}`,
    onClick: () => setShowInit(!showInit)
  }, "\u2694 Initiative"), /*#__PURE__*/React.createElement(MeasureMenu, {
    measureMode: measureMode,
    setMeasureMode: setMeasureMode
  }), /*#__PURE__*/React.createElement("button", {
    className: `btn ${showDraw ? 'active' : ''}`,
    ...
    className: "forced-view-banner"
  }, syncStatus === 'connecting' ? 'Connecting to the table…' : syncStatus === 'reconnecting' ? 'Reconnecting…' : syncStatus === 'error' ? 'Connection error. Trying to reach the DM…' : 'Offline')), showInit && /*#__PURE__*/React.createElement(InitiativeTracker, {
    state: state,
    dispatch: () => {},
    mode: "player",
    onClose: () => setShowInit(false)
